...
{
    /// <summary>
    /// Size in cells of the avalible space grid.
    /// </summary>
    [SerializeField] private Vector2Int _availableSpaceSize = new Vector2Int(18, 10);
    ...
    private void OnDrawGizmos()
    {
        ...
        for (int x = -_availableSpaceSize.x / 2; x < _availableSpaceSize.x / 2; x++)
        {
            ...
            {
                Gizmos.DrawWireCube(_grid.GetCellCenterLocal(new Vector3Int(x, y)), _grid.cellSize);
            }
        }
        ...
        {
            Gizmos.DrawWireCube(_grid.GetCellCenterLocal((Vector3Int)cell), _grid.cellSize);
        }
    }
